...
def wildfire():
	...
	for step in range(num_steps + 10):
		...
		if step < size:
			temperatures_old[0][step] = burn_temperature

		if step > 39 and step < size + 40:
			temperatures_old[20][step - 40] = burn_temperature
			
		if step > 79 and step < size + 80:
			temperatures_old[60][step - 80] = burn_temperature
