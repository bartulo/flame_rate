# PROBLEM 2
#
#111111i This program simulates a wildfire in a square area of forest.  Taking into 
...
def wildfire():
    ...
    wood_old = wood_1 * numpy.ones([size, size]) # kg / m2
